...
tracks_list = [
    ...
    {"location": "Circuit de Barcelona-Catalunya",
     "layout": ["Grand Prix Circuit",
                "National Circuit",
                "National Circuit Alt"]},
    {"location": "Circuit de Spa-Francorchamps",
     "layout": ["Full Circuit"]},
    {"location": "Daytona International Speedway",
     "layout": ["Sports Car Circuit",
                "Tri-Oval Circuit"]},
    {"location": "Eaglerock Speedway",
     "layout": ["Oval Circuit",
                "Club Circuit",
                "Club Circuit Reverse"]},
    {"location": "Grand Oak Raceway",
     "layout": ["National Circuit",
                "Club Circuit",
                "National Circuit Reverse"]},
    {"location": "Hakone",
     "layout": ["Grand Prix Circuit",
                "Club Circuit",
                "Club Circuit Reverse"]},
    ...
    {"location": "Kyalami Grand Prix Circuit",
     "layout": ["Grand Prix Circuit"]},
    {"location": "Le Mans - Circuit International De La Sarthe",
     "layout": ["Full Circuit",
    ...
    {"location": "Lime Rock Park",
     "layout": ["Full Circuit",
                "South Chicane",
                "Full Circuit Alt"]},
    {"location": "Mobil 1 Presents Maple Valley",
     "layout": ["Full Circuit",
                "Short Circuit",
    ...
    {"location": "Sunset Peninsula Raceway",
     "layout": ["Full Circuit",
                "Club Circuit",
    ...
    {"location": "Virginia International Raceway",
     "layout": ["Full",
                ...
                "Grand West",
                "Grand East"]},
    {"location": "Watkins Glen International Speedway",
     "layout": ["Full Circuit",
                "Short Circuit"]},
